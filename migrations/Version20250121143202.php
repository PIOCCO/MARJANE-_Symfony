 ...
 */
final class Version20250121143202 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `order` ADD customer_id INT NOT NULL, CHANGE numbrt number VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `order` DROP customer_id, CHANGE number numbrt VARCHAR(255) NOT NULL');
    }
}
